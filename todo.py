...
#
# JSON STRUCTURE: [[["Note1", "color", "Group"], ["Note2", "color2", "Group"]], ["Group1", "Group2"]]
#
...
def insert():
    ...
    group = jsonarray[1][char_pos]

    if(args_len >= 4):
        counter = 0
        string = ""
        while counter != args_len - 2:
            counter+=1
            string+=args[counter+2] + " "
        jsonarray[0].append([string[:-1], "1", group])
    else:
        jsonarray[0].append([args[3], "1", group])
...
def delete():
    ...
    group_counter = 0
    for note in jsonarray[0]:
        if(group == note[2]):
            group_counter+=1

            if(int(note_nr) == group_counter + 1):
                jsonarray[0].pop(group_counter)
                break
            ...
            if(int(note_nr) == group_counter + 1):
                if(args_len >= 4):
                    ...
                    while counter != args_len - 2:
                        counter+=1
                        string+=args[counter+2] + " "
                    jsonarray[0][group_counter][0] = string[:-1]
                else:
                    jsonarray[0][group_counter][0] = args[3]
                break
...
def editgroup():
    ...
    for note in jsonarray[0]:
        if(group == note[2]):
            ...
            if(int(note_nr) == group_counter):
                jsonarray[0][group_counter - 1][2] = args[3]
    ...
    for note in jsonarray[0]:
        if(group == note[2]):
            ...
            if(int(note_nr) == group_counter + 1):
                ...
                jsonarray[0][group_counter][1] = color
                break
...
def removedone():
    ...
    for note in jsonarray[0]:
        if(note[1] == "3" or note[1] == "green"):
            jsonarray[0].remove(note)
